...
import 'package:bandu_business/src/widget/main/employer/empty_employee_item_widget.dart';
...
class EmptyEmployeesScreen extends StatefulWidget {
  const EmptyEmployeesScreen({super.key});

  @override
  State<EmptyEmployeesScreen> createState() => _EmptyEmployeesScreenState();
}

class _EmptyEmployeesScreenState extends State<EmptyEmployeesScreen> {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<HomeBloc, HomeState>(
        listener: (context, state) {
          if (state is GetEmptyEmployeesSuccessState) {
            data = state.data;
            setState(() {});
          }
        },
        builder: (context, state) {
          if (state is GetEmptyEmployeesLoadingState && data == null) {
            return Column(
              children: [
                TopBarWidget(
                  isBack: true,
              ...
              if (data != null && _hasEmployees(data!))
                ...
                Expanded(
                  child: RefreshIndicator(
                    ...
                    child: Center(
                      child: EmptyWidget(
                        text: "noEmptyEmployeesAvailable".tr(),
  ...
  bool _hasEmployees(DashboardEmployeesEmptyData data) {
