...
class BookedPlacesScreen extends StatefulWidget {
  ...
  @override
  State<BookedPlacesScreen> createState() => _BookedPlacesScreenState();
}

class _BookedPlacesScreenState extends State<BookedPlacesScreen> {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<HomeBloc, HomeState>(
        listener: (context, state) {
          if (state is GetBookedPlacesSuccessState) {
            data = state.data;
            setState(() {});
          }
        },
        builder: (context, state) {
          if (state is GetBookedPlacesLoadingState && data == null) {
            return Column(
              children: [
                TopBarWidget(
                  isBack: true,
  ...
  bool _hasPlaces(DashboardPlacesBookedData data) {
